...
func _input(event):
	...
	if event.is_action_released("crouch") and TOGGLE_CROUCH == false: #releasing the crouch
...
func _ready():
	...
	#setting the default speed of the player
...
func _physics_process(delta):
	...
	global.debug.add_property("MovementSpeed",_speed,0)
